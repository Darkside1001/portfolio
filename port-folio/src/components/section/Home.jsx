        ...
        >
            <div className="text-center z-6 px-100">
               ...
               <div className="flex justify-center space -x-4">
                <a href="#projects"
                className="bg-blue-500 text-white py-3 px-6 rouned font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-0_0_15px-rgba(59, 130, 246, 0.2)"
